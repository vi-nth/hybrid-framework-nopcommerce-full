...
public class Register extends BaseTest {
	...
	public void Register_01_Emty_Data(Method method) {
		...
		ExtentTestManager.startTest(method.getName(), "Register unsuccessfully with empty data");
	...
	public void Register_02_Invalid_Email(Method method) {
		ExtentTestManager.startTest(method.getName(), "Register unsuccessfully with invalid Email");
		ExtentTestManager.getTest().log(Status.INFO, "HomePage - Step 01: Click on 'Register'link at menu");
		registerPage = userHomePage.clickToPageLink("Register");
	...
	public void Register_04_Existing_Email(Method method) {
		ExtentTestManager.startTest(method.getName(), "Register unsuccessfully with exsiting Email");
		ExtentTestManager.getTest().log(Status.INFO, "HomePage - Step 01: Click on 'Register'link at menu");
		registerPage = userHomePage.clickToPageLink("Register");
	...
	public void Register_05_Valid_Email_And_Password_Less_Than_6_Chars(Method method) {
		ExtentTestManager.startTest(method.getName(), "Register unsuccessfully with password less than 6 chars");
		ExtentTestManager.getTest().log(Status.INFO, "HomePage - Step 01: Click on 'Register'link at menu");
		registerPage = userHomePage.clickToPageLink("Register");
	...
	public void Register_06_Register_With_Incorrect_Confirm_Password(Method method) {
		ExtentTestManager.startTest(method.getName(), "Register unsuccessfully with invalid Confirm Password");
		ExtentTestManager.getTest().log(Status.INFO, "HomePage - Step 01: Click on 'Register'link at menu");
		registerPage = userHomePage.clickToPageLink("Register");
